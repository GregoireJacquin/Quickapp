...
Pod::Spec.new do |s|
  ...
  #
  s.author       = { "gregoirejacquin" => "gregoire.jacquin@me.com" }
  # s.authors      = { "gregoirejacquin" => "gregoire.jacquin@me.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'gregoirejacquin', 'other author'
